...
//    }
    ...
    static class Dobro implements Operacao{
        @Override
    ...
    public class OperacoesRefatoradas{
        public static int executarOperacao(int valor, Operacao operacao) { return operacao.executar(valor); }
    }

    public static void main(String[] args){
        Operacao operacao = new Dobro();
        int result = OperacoesRefatoradas.executarOperacao(5, operacao);
